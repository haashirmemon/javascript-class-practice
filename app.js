...
// fruits.splice(1,0,'gvava','nashpati',, 'falsa','anaar')
...
//     name : 'haashir',
//     role :'web developer',
//     company:'haashirs machinery'
// }

// for (const key in obj){
//        console.log(key,obj);
// }
// for (const h of'haashir') {
//     console.log(h);
// }
// console.log('hello world');
// for (let i= 2; i <=100; i++) {
...
// const names =['haashir' ,  'shakeel' , 'abdulhabib' ,'suleman','haashir' ,  'shakeel','abdulhabib','suleman']
// console.log(names);
// const ul =document.querySelector('ul');
...
// const shop = ['banana','apple','mango','grapes','watermelon']
// const input=document.querySelector('#input')
// const  h2 =document.querySelector('h2')
// function getfruits(){
//     console.log('input.value');
//     if (shop.includes(input.value)){
//         console.log('fruits available hai');
//         h2.innerHTML =`${input.value} is available`
//     }
//     else {
//         console.log('fruits available nahi hai');
...
// var x = +prompt('where does you number')
// if (x===87) {
//     alert('show your number')
// } else {
//     alert('bekaar hai bhayya mai to toot gaya')
// }
